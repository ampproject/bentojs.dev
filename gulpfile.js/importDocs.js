...
function _rewriteUsage(contents, componentName) {
  const usage = `<div class="bd-usage bd-card bd-card--light-sea-green"><p>Use ${componentName} as a web component or a React functional component:</p><a class="bd-button" href="#web-component">↓ Web Component</a><a class="bd-button" href="#preact%2Freact-component">↓ React / Preact</a></div>\n## Web Component`;
