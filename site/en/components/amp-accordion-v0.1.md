...
teaser:
  text: >-
    A stacked list of headers that collapse or expand content sections with user
    interaction.
toc: true
title: amp-accordion
version: '0.1'
...
scripts:
  - js: >-
    ...
    css: >-
      <link rel="stylesheet"
      href="https://cdn.ampproject.org/v0/amp-accordion-0.1.css">
bentoPath: /documentation/components/amp-accordion-v1.0.html
is_current: true
$path: /documentation/components/amp-accordion.html
$localization:
  path: '/{locale}/documentation/components/amp-accordion.html'
---
