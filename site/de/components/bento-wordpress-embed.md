...
permalink: "/de/components/bento-wordpress-embed/"
short_title: WordPress Embed
layout: layouts/component.njk
description: Ein iframe, das einen <a href="https://make.wordpress.org/core/2015/10/28/new-embeds-feature-in-wordpress-4-4/">Auszug</a> aus einem WordPress Beitrag oder einer WordPress Seite anzeigt.
---
...
Ein iframe, das einen [Auszug](https://make.wordpress.org/core/2015/10/28/new-embeds-feature-in-wordpress-4-4/) aus einem WordPress Beitrag oder einer WordPress Seite anzeigt.

<div class="bd-usage bd-card bd-card--light-sea-green">   <p>Verwende bento-wordpress-embed als Webkomponente oder als funktionale React Komponente:</p>   <a class="bd-button" href="#web-component">↓ Webkomponente</a>   <a class="bd-button" href="#preact%2Freact-component">↓ React / Preact</a>
</div>
...
Die URL des einzubettenden Beitrags. Wird der Attributwert programmatisch geändert, so wird der eingebettete Inhalt automatisch aktualisiert.
