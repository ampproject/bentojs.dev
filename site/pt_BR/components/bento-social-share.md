...
Alterar programaticamente qualquer um dos valores de atributo atualizará automaticamente o elemento. Por exemplo, alterando o `type`, você pode alternar entre diferentes provedores de compartilhamento.
