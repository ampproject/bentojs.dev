...
<body>
  <bento-date-countdown timeleft-ms="200000000" biggest-unit="HOURS">
    <template type="amp-mustache">
      <div>
        <span>{% raw %}{{days}}{% endraw %} {% raw %}{{dd}}{% endraw %} {% raw %}{{d}}{% endraw %}</span>
        <br />
        <span>{% raw %}{{hours}}{% endraw %} {% raw %}{{hh}}{% endraw %} {% raw %}{{h}}{% endraw %}</span>
        <br />
        <span>{% raw %}{{minutes}}{% endraw %} {% raw %}{{mm}}{% endraw %} {% raw %}{{m}}{% endraw %}</span>
        <br />
        <span>{% raw %}{{seconds}}{% endraw %} {% raw %}{{ss}}{% endraw %} {% raw %}{{s}}{% endraw %}</span>
      </div>
    </template>
  </bento-date-countdown>
</body>
